  ...
  return (
    <Box>
      ...
      <Typography variant="body2" mb={2}>
        By default, &apos;Only Active Campaigns&apos; filter should be applied,
        however you might be interested in all campaigns. To do that you need to
        toggle the switch in a right side of a page.
      </Typography>
      ...
      <Typography variant="body2">
        <strong>Type: </strong>The campaign type, can be Holding or Market
        Making.
      </Typography>
      <Typography variant="body2">
        <strong>Network: </strong>Network on which campaign is created and where
        you will get your rewards.
      </Typography>
      <Typography variant="body2">
        <strong>Address: </strong>Since every campaign is a smart contract, you
        can check the information about this contract in a blockchain explorer.
      </Typography>
      <Typography variant="body2">
        <strong>Start date: </strong>A date when the campaign starts (might be
        in the future).
      </Typography>
      <Typography variant="body2">
      ...
      >
        <Box display="flex" alignItems="center" gap={0.5}>
          <Box
            ...
            height="8px"
            borderRadius="100%"
            border="1px solid rgba(212, 207, 255, 0.50)"
        ...
        <Box display="flex" alignItems="center" gap={0.5}>
          ...
          />
          <Typography variant="body2" fontSize={9}>
            Campaign is finished, waiting for payouts
          </Typography>
        </Box>
        <Box display="flex" alignItems="center" gap={0.5}>
          <Box
      ...
      <Typography variant="body2">
        You can click on a campaign you want to participate in and you will be
        redirected to the campaign details page.
      </Typography>
      <Typography variant="body2">
        To join the campaign you need to click on &apos;Join Campaign&apos;.
          ...
          <ListItemText
            primary={
              <Typography variant="body2">
                ...
                API key for the exchange, where trades need to be made to the
                platform. In this case &apos;Join Campaign&apos; button will be
                replaced with &apos;Registered to Campaign&apos; button.
              </Typography>
            }
            slotProps={listItemTextProps}
          />
      ...
      <Typography variant="body2">
        You can always check the list of the campaigns you joined to by choosing
        &apos;Joined Campaigns&apos; on a home page.
      </Typography>
    </Box>
  );
};
