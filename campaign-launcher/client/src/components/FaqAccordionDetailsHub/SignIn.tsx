  ...
  return (
    <Stack>
      <Typography variant="body2" mb={2}>
        Joining a campaign requires signing a message on the chain and API keys
            ...
            primary={
              <>
                <Typography variant="body2">
                  To add a new API key, click on &apos;Add new key&apos;. Then
                  select the exchange and paste the keys there.
                </Typography>
                <Typography variant="body2">
                  Remember: we require only read-only API keys with permissions
                  to only fetch trades. Please, check{' '}
                  <Link
                  ...
                  on how to generate these keys on the exchange.
                </Typography>
              </>
            }
            slotProps={listItemTextProps}
