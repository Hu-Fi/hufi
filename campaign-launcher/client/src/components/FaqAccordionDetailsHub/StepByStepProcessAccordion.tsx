    ...
    <>
      <Accordion disableGutters slotProps={{ ...firstSmallAccordionProps }}>
        ...
        <AccordionDetails sx={{ ...smallAccordionDetailsProps }}>
          ...
          <Typography variant="body2">
            Date when the campaign will start. If you choose today&apos;s date,
            the campaign will start immediately, otherwise it will start at
            00:00 your timezone of the date you chose.
          </Typography>
          <Typography variant="body2" fontWeight={700}>
            End date:
          </Typography>
          ...
          <Typography variant="body2">
            Amount of the reward you want to fund an escrow with. This amount
            will be divided into the campaign duration to form a daily reward
            pool. Just remember, the higher the reward, more enthusiastic
            participants will be about your campaign.
          </Typography>
          <Typography variant="body2" fontWeight={700}>
            Daily volume target:
          </Typography>
          <Typography variant="body2">
            A target you want to set for a quote token that should be reached
            daily. If participants reach this target (and above), the daily
            reward pool will be distributed fully, otherwise proportionally to
            the target you set.
          </Typography>
        </AccordionDetails>
      </Accordion>
      <Accordion disableGutters slotProps={{ ...smallAccordionProps }}>
        ...
        <AccordionDetails sx={{ ...smallAccordionDetailsProps }}>
          ...
          <Typography variant="body2">
            A target you want to set for the total amount of assets held on the
            exchange that should be maintained daily. If participants meet or
            exceed this target, the daily reward pool will be distributed fully;
            otherwise, rewards will be distributed proportionally to the
            achieved balance relative to the target.
          </Typography>
        </AccordionDetails>
      </Accordion>
    </>
