    ...
    <Stack>
      <Accordion disableGutters slotProps={{ ...firstSmallAccordionProps }}>
        ...
        <AccordionDetails sx={{ ...smallAccordionDetailsProps }}>
          <Typography variant="body2">
            Every campaign has 3 parameters: fund amount, duration and daily
            volume target. The first step is calculating the daily reward pool:
          </Typography>
          <Typography variant="body2">
            <Typography
              component="span"
            ...
            For the duration we use <code>Math.ceil()</code> function which
            means that 25 hours will be considered as 2 days.
          </Typography>
          <Typography variant="body2">
            For each campaign, we track progress in 24-hour periods from its
            start by fetching all trades made by participants and check whether
            the combined generated volume reaches the daily volume target.
          </Typography>
      ...
      <Accordion disableGutters slotProps={{ ...smallAccordionProps }}>
        ...
        <AccordionDetails sx={{ ...smallAccordionDetailsProps }}>
          <Typography variant="body2">
            Every campaign has 3 parameters: fund amount, duration and daily
            balance target. The first step is calculating the daily reward pool:
          </Typography>
          <Typography variant="body2">
            <Typography
              component="span"
          ...
          <Typography variant="body2">
            For each campaign, we track progress in 24-hour periods from its
            start by fetching participants balances and check whether the sum of
            them reaches the daily balance target.
          </Typography>
          <List component="ul" sx={{ listStyleType: 'disc', p: 0, pl: 2 }}>
            <ListItem sx={listItemWithMarkerProps}>
              <ListItemText
