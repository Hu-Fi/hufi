...
const ConnectWallet: FC = () => {
	...
	return (
		<>
			<Button variant="contained" size="large" sx={{ color: "primary.contrast", fontWeight: 600 }} onClick={(event) => setAnchorEl(event.currentTarget)}>
        Connect Wallet
      </Button>
			<Popover
				open={!!anchorEl}
			...
			>
				<Box display="flex" alignItems="center" justifyContent="flex-end" mb={2}>
					<IconButton sx={{ padding: 1, '&:hover': { bgcolor: 'unset' } }} onClick={() => setAnchorEl(null)}>
