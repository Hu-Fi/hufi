...
export class InitialSetup1749653750354 implements MigrationInterface {
  name = 'InitialSetup1749653750354';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "hu_fi"."user_campaigns" ("user_id" uuid NOT NULL, "campaign_id" uuid NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL, "exchange_api_key_id" uuid, CONSTRAINT "PK_8ccc7f91e6aa94ef3e1c672f000" PRIMARY KEY ("user_id", "campaign_id"))`,
    );
    await queryRunner.query(
