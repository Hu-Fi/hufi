...
export class InitialSetup1749111176248 implements MigrationInterface {
  name = 'InitialSetup1749111176248';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "hu_fi"."exchange_api_keys" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "exchange_name" character varying(20) NOT NULL, "api_key" character varying(1000) NOT NULL, "secret_key" character varying(1000) NOT NULL, "user_id" uuid NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL, "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL, CONSTRAINT "PK_3751a8a0ef5354b32b06ea43983" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
